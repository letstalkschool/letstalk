      ...
      <div className="container-custom">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="tel:+48660174331" className="text-gray-400 hover:text-white">+48 660 174 331</a>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-brand-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">poznanletstalk@gmail.com</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-brand-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-400 text-center md:text-left mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Let's Talk! Roma Górska. Wszelkie prawa zastrzeżone.
          </p>
